...
const faqItems = [
  {
    question: "Сколько стоит натяжной потолок в Обнинске, Калуге или Боровске?",
    answer:
      "Цена зависит от площади, типа полотна и опций (карнизы, подсветка, количество светильников). ПВХ-потолок под ключ — от 700 ₽ за м². Точную стоимость рассчитаем бесплатно на замере или воспользуйтесь калькулятором на сайте.",
  },
  {
    question: "Сколько времени занимает монтаж натяжного потолка?",
    answer:
      "Стандартная комната площадью 15–20 м² монтируется за 1 день. Многоуровневые потолки со сложной подсветкой и криволинейными формами могут занять 1–2 дня.",
  },
  {
    question: "Даёте ли вы гарантию на натяжные потолки?",
    answer:
      "Да, официальная гарантия на полотно и монтаж — 15 лет. Работаем по договору, где фиксируем все условия, сроки и стоимость.",
  },
  {
    question: "Замер и выезд специалиста — платно?",
    answer:
      "Нет, замер и расчёт точной стоимости всегда бесплатны и ни к чему не обязывают. Специалист приедет в удобное время и предложит несколько вариантов дизайна.",
  },
  {
    question: "В каких городах вы работаете?",
    answer:
      "Устанавливаем натяжные потолки в Обнинске, Калуге, Боровске, Жукове и Наро-Фоминске, а также в ближайших населённых пунктах.",
  },
  {
    question: "Какой натяжной потолок выбрать: ПВХ или тканевый?",
    answer:
      "ПВХ-плёнка дешевле, влагостойкая и подходит для кухонь и ванных. Тканевый потолок — бесшовный, дышащий и экологичный, хорошо смотрится в больших залах. Поможем выбрать вариант под ваш бюджет и задачу на бесплатной консультации.",
  },
];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-4 overflow-x-auto pb-3" style={{ scrollSnapType: "x mandatory", scrollbarWidth: "none" }}>
            {[
              ...
              { slug: "/portfolio/films", title: "Виды плёнок", desc: "Глянец, матовый, сатин, фотопечать", color: "#10B981", icon: "Palette", img: "https://cdn.poehali.dev/projects/707775f1-2704-4286-b889-aa5532b2e0df/bucket/93a839e8-a8bb-4a62-9818-fddc1c710a05.jpeg" },
              { slug: "/portfolio/spotlights", title: "Светильники (втяжка)", desc: "Встраиваемые LED в полотно", color: "#EC4899", icon: "Lightbulb", img: "https://cdn.poehali.dev/projects/707775f1-2704-4286-b889-aa5532b2e0df/bucket/f580be16-e088-4afd-97f4-a0a3742df684.jpeg" },
              { slug: "/portfolio/light-lines", title: "Световые линии", desc: "Тонкие светящиеся полосы в потолке", color: "#7C3AED", icon: "Zap", img: "https://cdn.poehali.dev/projects/707775f1-2704-4286-b889-aa5532b2e0df/files/9610b5aa-7d30-408d-a329-724e4789855d.jpg" },
              { slug: "/portfolio/track-lighting", title: "Трековое освещение", desc: "Светильники на гибкой шине", color: "#F59E0B", icon: "Move", img: "https://cdn.poehali.dev/projects/707775f1-2704-4286-b889-aa5532b2e0df/files/524441c5-7988-4e74-8009-f490fb319f39.jpg" },
              { slug: "/portfolio/light-ceilings", title: "Световые потолки", desc: "Полотно светится изнутри", color: "#06B6D4", icon: "Sun", img: "https://cdn.poehali.dev/projects/707775f1-2704-4286-b889-aa5532b2e0df/files/3d678a67-fcdf-4602-aa63-b1250169204f.jpg" },
              { slug: "/portfolio/shadow-vents", title: "Теневые вытяжки", desc: "Вентиляция в теневом зазоре", color: "#10B981", icon: "Wind", img: "https://cdn.poehali.dev/projects/707775f1-2704-4286-b889-aa5532b2e0df/files/9dc7a610-130d-4312-9e13-d13f10327d37.jpg" },
              { slug: "/portfolio/curtain-niches", title: "Ниши для электрокарниза", desc: "Скрытый привод моторизованных штор", color: "#F97316", icon: "Blinds", img: "https://cdn.poehali.dev/projects/707775f1-2704-4286-b889-aa5532b2e0df/files/c141de12-7ce7-433e-96ec-e78bfbad6448.jpg" },
              { slug: "/portfolio/builtin-cornices", title: "Встраиваемые карнизы для штор", desc: "Штора «вырастает» из потолка", color: "#7C3AED", icon: "Blinds", img: "https://cdn.poehali.dev/projects/707775f1-2704-4286-b889-aa5532b2e0df/files/6bced623-83d8-4ead-aa55-d90ed81172c4.jpg" },
            ].map(item => (
              <a
                key={item.slug}
                href={item.slug}
