...
export default function ShadowCeilings() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "#1a1438", color: "#fff" }}>
      <Seo
        title="Теневые натяжные потолки — теневой профиль под ключ | ПотолкиLeKo"
        description="Теневой натяжной потолок с эффектом парения: ровный технологический зазор между полотном и стеной без пластиковых заглушек. Гарантия качества."
      ...
      <CityCoverage serviceName="Теневые натяжные потолки" serviceGenitive="теневые натяжные потолки" />
