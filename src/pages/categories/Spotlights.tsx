...
export default function Spotlights() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "#1a1438", color: "#fff" }}>
      <Seo
        title="Светильники-втяжка для натяжного потолка | ПотолкиLeKo"
        description="Встраиваемые светильники, врезанные в полотно натяжного потолка — точечное, GU10, MR16 и LED-панели освещение с ровной гладкой поверхностью."
      ...
      <div className="max-w-7xl mx-auto px-4 pt-24">
        <Breadcrumbs items={[{ label: "Портфолио", path: "/portfolio" }, { label: "Светильники" }]} />
      </div>
