...
export default function CurtainNiches() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "#1a1438", color: "#fff" }}>
      <Seo
        title="Ниши для электрокарниза в натяжном потолке | ПотолкиLeKo"
        description="Углубление в потолке под моторизованный карниз — привод, рельса и провода полностью скрыты. Монтаж натяжных потолков с нишей под ключ."
        path="/portfolio/curtain-niches"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 pt-24">
        <Breadcrumbs items={[{ label: "Портфолио", path: "/portfolio" }, { label: "Ниши для электрокарниза" }]} />
      </div>
      ...
      <CityCoverage serviceName="Ниши для электрокарниза" serviceGenitive="натяжные потолки с нишей для электрокарниза" />
